...
*/
    ...
    struct GenericStringRef {
        ...
        GenericStringRef(const CharType *str, SizeType len)
                : s(CEREAL_RAPIDJSON_LIKELY(str) ? str : emptyString), length(len) {
            CEREAL_RAPIDJSON_ASSERT(str != 0 || len == 0u);
        }
...
*/
    ...
    public:
        ...
        */
        ...
        explicit GenericValue(float f) CEREAL_RAPIDJSON_NOEXCEPT: data_() {
        ...
        */
        GenericValue &AddMember(GenericValue &name, GenericValue &value, Allocator &allocator) {
            ...
            if (o.size >= o.capacity)
                MemberReserve(o.capacity == 0 ? kDefaultObjectCapacity : (o.capacity + (o.capacity + 1) / 2),
                              allocator);
