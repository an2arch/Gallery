...
public:
    ...
    // с этого метода начинается обработка
...
private:
    ...
    // стек указателей на рабочие экраны
    ...
    // триггер отвечающий за показатель работы программы
    ...
    // метод возврата экрана из стека
    // возвращает false - если в стеке больше нет экранов
